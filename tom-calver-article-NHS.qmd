...
# 
# font_paths <- c(
#   'renv/library/macos/R-4.5/aarch64-apple-darwin20/Roboto/static/Roboto-Regular.ttf',
#   'renv/library/macos/R-4.5/aarch64-apple-darwin20/Roboto/static/Roboto-Bold.ttf',
#   'renv/library/macos/R-4.5/aarch64-apple-darwin20/Roboto/static/Roboto_Condensed-Regular.ttf',
#   'renv/library/macos/R-4.5/aarch64-apple-darwin20/Roboto/static/Roboto_Condensed-Bold.ttf'
# )
# 
# # roboto regular + bold
# sysfonts::font_add(
#   family = "Roboto Condensed",
#   regular = font_paths[1],
#   bold = font_paths[2]
# )
# 
...
#### Data Visualization 
**Notes on the plot:** Overall, I really liked this plot, and its replication. If I am being nitpicky, I am not a fan of the US values going outside of the plot panel (for older years; first three years).<br>
