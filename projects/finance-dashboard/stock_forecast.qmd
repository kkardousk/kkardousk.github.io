...
def render_plot(fig):
    """Render Plotly figure with embedded JS (no CDN required)"""
...
for i, ticker in enumerate(tickers):
    ...
    render_plot(calendar_stock_display([ticker], show_disclaimer=show_disclaimer))
