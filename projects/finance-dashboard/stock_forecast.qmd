...
def plot_single_comparison(data, title="Stock Price Comparison", height=500):
    """
    create a single plot with all stocks for comparison - ggplot2 style
    """
    ...
    fig.update_layout(
        ...
        title=dict(
            ...
            x=0.5,
            xanchor='center',
            font=dict(size=16, family='Merriweather, Georgia, serif', color='#333333')
        ),
        showlegend=True,
        legend=dict(
            orientation='h',
...
HTML(to_html(comparison_chart, include_plotlyjs='cdn', full_html=False))
...
for i, ticker in enumerate(tickers):
    ...
    calendar_chart = calendar_stock_display([ticker], show_disclaimer=show_disclaimer)

display(calendar_chart)
```
