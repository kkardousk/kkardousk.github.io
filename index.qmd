...
::: {.g-col-5}
# Where Data Meets <span id="cycling-text" class="animated-word">Curiosity</span> {.text-center}
...
<script>
const words = ['Curiosity', 'Discovery', 'Insight'];
let currentIndex = 0;
...
::: {.project-footer}
[View Project](projects/finance-dashboard/stock_forecast.qmd){.btn .btn-primary}
:::
:::
