...
Replication of a data-driven article and analysis of the UK's healthcare systems among other countries; by British editor Tom Calver
...
Here I explore some ways to draw cool looking objects, here snowflakes namely using fractals and their properties - inspired by Micmaths.

[View Project](inversions_py/koch_snowflake_fractals.qmd){.btn .btn-primary}
:::

::: {.project-card style="background-color: #f9f9f9; color: #263646;"}
### **The Case of Journalism in Gaza** {.project-title}
Replication of ACLED Visual (Armed Conflict Location and Event Data) where the data looks at casualties among journalists since October 2023 through to end of August 2025.

[View Project](journalism_and_political_violence.qmd){.btn .btn-primary}
:::

::: {.project-card style="background-color: #f9f9f9; color: #263646;"}
### **The 9/11 Legacy** {.project-title}
Replication of a PEW Research Center where the data looks at, among other things, the emotional toll of 9/11, its enduring legacy, and its polarizing impact on the Political Spectrum. 

[View Project](sept11_legacy.qmd){.btn .btn-primary}
:::
